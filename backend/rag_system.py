...
class RAGSystem:
    ...
    def query(self, query: str, session_id: str | None = None) -> tuple[str, list[str], list[str]]:
        """
        ...
        Returns:
            Tuple of (response, sources list, source links list)
        """
        ...
        # Get sources and links from the search tool
